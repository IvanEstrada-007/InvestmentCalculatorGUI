...
Chapter 8 example of a GUI-based version of the investment calculator
...
NOTE: The file breezypythongui.py MUST be in the same directory for the app to run correctly!.
...
class investmentGUI(EasyFrame):
	...
	# definition of the compute() function for event handling
	def compute(self):
